...
def extract_breweries():
    ...
    MinioClient().upload_json("datalake", "1. bronze/001_breweries/breweries.json", data)

def extract_metadata():
    b = Breweries()
    metadata = b.get_breweries_metadata()
    logging.info(f"Metadados extraídos: {metadata}")
    MinioClient().upload_json("datalake", "1. bronze/001_breweries/metadata.json", metadata)
